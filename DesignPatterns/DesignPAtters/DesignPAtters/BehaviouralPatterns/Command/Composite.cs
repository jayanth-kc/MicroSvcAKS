...
namespace DesignPatterns.BehaviouralPatterns.Command.Composite
{
    ...
    abstract class CompositeBankAccountCommand : List<BankAccountCommand>, DesignPatterns.BehaviouralPatterns.Command2.ICommand
    {
