...
namespace DesignPatterns.StructuralPatterns.Adapter
{
    ...
    //Adaptee : class contains the functionality which the client requires but it’s not compatible with the existing client code
    ...
    //Client Interface: 
    public interface ITarget //Client exposed interface to process the salary
    {
        void ProcessCompanySalary(string[,] employeesArray);
    }

    //Adapter class which combines together 
    //Two different class Employee and Thirdparty Billing system
