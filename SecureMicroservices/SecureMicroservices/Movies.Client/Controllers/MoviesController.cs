...
namespace Movies.Client.Controllers
{
    ...
    public class MoviesController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var movie = await _movieApiService.GetMovies();//.FirstOrDefaultAsync<IEnumerable<Movie>>(m => m.Id == id);
            if (movie == null)
            {
                return NotFound();
            }
        ...
        //    var movie = await _movieApiService.DeleteMovie(id);
        //    if (movie == null)
        //    {
        //        return NotFound();
        //    }
        ...
        {
           //  return _movieApiService.GetMovies().Any(e => e.Id == id);
            return true;
        }
